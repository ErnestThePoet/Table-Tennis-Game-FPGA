...
// Implementation of the game. Manages game state, handles hardware input and updates display.
...
module InteractionHandler(
    ...
    parameter reg[7:0] DIGIT_NUMS[0:9]={
        8'b00111111,
        8'b00000110,
        8'b01011011,
        8'b01001111,
    ...
    // Scores:left, right
    integer scores[1:0]={0,0};  // TO BE MANAGED
    // Serves:left, right
    integer serves[1:0]={0,0};  // TO BE MANAGED
    // Character display buffer and position pointer for left side.
    reg[7:0] ledBuffer[0:7]={
        DIGIT_DASH,
        DIGIT_t,
        DIGIT_E,
        DIGIT_N,
        ...
        DIGIT_I,
        DIGIT_S,
        DIGIT_DASH};  // TO BE MANAGED
    integer ledBufferPosL=0;
    ///////////////////////////////////////////////////////////////////////////////////////////////

    ClockGenerator #(1,100) clock_generator_ms(hwClock,clockMs);
